...
public interface RuVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link RuParser#sentencia_funcion}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSentencia_funcion(RuParser.Sentencia_funcionContext ctx);
	/**
	 * Visit a parse tree produced by {@link RuParser#bloque_de_sentencia_func}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBloque_de_sentencia_func(RuParser.Bloque_de_sentencia_funcContext ctx);
	/**
	 * Visit a parse tree produced by {@link RuParser#bloque_func}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBloque_func(RuParser.Bloque_funcContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLlamadaFuncionExpr(RuParser.LlamadaFuncionExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLogExpr(RuParser.LogExprContext ctx);
	/**
